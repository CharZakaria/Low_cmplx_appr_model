...
def _main():
    annotation_path = 'dataset/annotation.txt'
    log_dir = 'logs/000/'
    # classes_path = 'model_data/voc_classes.txt'
    classes_path = 'model_data/howdrive_classes.txt'
    anchors_path = 'model_data/tiny_yolo_anchors.txt'
    class_names = get_classes(classes_path)
    num_classes = len(class_names)
    anchors = get_anchors(anchors_path)

    input_shape = (224,288)# old value (416,416) # multiple of 32, hw
...
def data_generator(annotation_lines, batch_size, input_shape, anchors, num_classes):
    ...
    while True:
        ...
        for b in range(batch_size):
            ...
            image, box = get_random_data('dataset/'+annotation_lines[i], input_shape, random=True)
